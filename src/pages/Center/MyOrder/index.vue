  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table v-for="order in orderList"
               :key="order.id"
               class="order-item">
          <thead>
          <tr>
          ...
          <tr v-for="(orderDetail, index) in order.orderDetailList">
            <td width="60%">
              <div class="typographic">
                <img width="80" height="80" :src="orderDetail.imgUrl">
...
export default {
    ...
    computed: {
        ...mapGetters('center', ['orderList', 'pageInfo'])
    },
    methods: {
        ...mapActions('center', {getOrderList: 'getOrderList'}),
